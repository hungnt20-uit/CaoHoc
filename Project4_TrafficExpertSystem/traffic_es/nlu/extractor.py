...
class HeuristicExtractor:
    ...
    def extract(self, text: str) -> Tuple[Facts, Dict[str, str], List[str]]:
        ...
        # Hỗ trợ cả kiểu dấu chấm và dấu phẩy, ví dụ "0.42" hoặc "0,45".
        ...
        # "vượt đèn đỏ" phải là vi phạm thật, không phải "không vượt đèn đỏ"
        if any(
            p in t and not has_negated_occurrence_only(t, p)
            for p in ("vượt đèn đỏ", "vượt đèn")
        ) or ("không chấp hành" in t and "đèn" in t):

...
_BOOL_PATS: List[Tuple[str, object, Tuple[str, ...]]] = [
    ...
    ("hanhvi.cam_dien_thoai", True, (
        "cầm điện thoại",
        "dùng điện thoại",
        "sử dụng điện thoại",
        "nghe điện thoại",
        "nhắn tin khi lái",
        "vừa lái vừa cầm điện thoại",
        "cầm điện thoai",  # lỗi chính tả thường gặp
        "cam dien thoai",
    )),
    ("hanhvi.su_dung_thiet_bi_am_thanh", True, (
        "đeo tai nghe",
        "tai nghe",
        "nghe nhạc khi lái",
        "thiết bị âm thanh",
    ...
    ("boicanh.vi_tri_cam_do", True, ("vị trí cấm đỗ", "biển cấm đỗ", "biển cấm dừng")),
